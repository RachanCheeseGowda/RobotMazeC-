...
AlgorithmBlockPlayer2::AlgorithmBlockPlayer2(QString blockType,QString direction,int steps,int y)
{
...
AlgorithmBlockPlayer2::~AlgorithmBlockPlayer2()
{

}

void AlgorithmBlockPlayer2::setImage()
{
    //START
...
/*void AlgorithmBlockPlayer2::keyPressEvent(QKeyEvent *event)
{
    qDebug()<<"w";
...
void AlgorithmBlockPlayer2::setSelectedImage()
{
    //START
    if(blockType=="START" &&direction==""&&steps==0){
...
int AlgorithmBlockPlayer2::getStart()
{
    return start;
}

void AlgorithmBlockPlayer2::setStart(int value)
{
    start = value;
}

QString AlgorithmBlockPlayer2::getBlockType() const
{
    return blockType;
}
...
//DO NOT TOUCH
/*
void AlgorithmBlockPlayer2::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
    if(this->blockType!="START"&&start==0){
        qDebug()<<"click";
        AlgorithmBlockPlayer2* a = new AlgorithmBlockPlayer2("","",0,0);
        //not the best method
...
void AlgorithmBlockPlayer2::setBlockType(QString s)
{
    blockType = s;
}

void AlgorithmBlockPlayer2::setDirection(QString s)
{
    direction = s;
}

void AlgorithmBlockPlayer2::setSteps(int i)
{
    steps = i;
}

int AlgorithmBlockPlayer2::getSteps()
{
    return steps;
}

void AlgorithmBlockPlayer2::setY(int i)
{
    y=i;
}

int AlgorithmBlockPlayer2::getY()
{
    return y;
}

QString AlgorithmBlockPlayer2::getDirection()
{
    return direction;
}
